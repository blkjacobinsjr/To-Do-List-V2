...
export function Tasks({ tasks, onComplete, onDelete, editTaskTitle}) {
    ...
    return (
        <section className={styles.tasks}>
            ...
            <div className={styles.list}>
                {tasks.map(task => (
                    <Task key={task.id} task={task} onComplete={onComplete} onDelete={onDelete} editTaskTitle={editTaskTitle}/>
                ))}
            </div>
        </section>
    )
